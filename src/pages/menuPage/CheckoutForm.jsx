  ...
  const navigate = useNavigate();
    ...
    useEffect(()=>{
      if(typeof price !== 'number' || price < 1){
        console.log("Price is not an number or less than 1")
        return;
      }
      ...
      <div className="md:w-1/3 space-y-5  card shrink-0 w-full max-w-sm shadow-2xl bg-base-100 px-4 py-8">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={!stripe}
            className="btn btn-sm mt-5 bg-orange-500 text-white btn-primary w-full border-none"
          >
            Pay
          </button>
        </form>
